  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="dropdown">
   	<a href="javascript:void(0)" class="brand-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="background-color: #004225";>
    ...
    <div class="sidebar" style="background-color: #186F65";>
      <nav class="mt-2" >
